...
export const OrderPage = () => {
  ...
  if(loading){
        return <p className="text-center text-gray-500">loading your order.......</p>
    }
  ...
  return (
    <div className="mx-auto max-w-3xl px-4 py-6 space-y-6">
      ...
      <div className="rounded-xl bg-white p-4 shadow-sm space-y-1">
       ...
       ( <UserOrderMap riderLocation={riderLocation} deliveryLocation={[order.deliveryAddress?.latitude!,
