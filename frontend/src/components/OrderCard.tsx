    ...
    <div className="rounded-xl bg-white p-4 shadow-sm space-y-3">
        ...
        }
        {
            order.status==="ready_for_rider" &&retryVisible&&(
                <div className="pt-2">
                    <button className="w-full rounded-lg border border-[#e23744] py-2 text-xs font-semibold text-[#e23744] hover:bg-red-50 disabled:opacity-50" onClick={()=>updateStatus("ready_for_rider")}  disabled={loading}>Retry Ready for Rider</button>
                </div>
            )
        }
    </div>
